...
describe('Vpc', () => {
  ...
  describe('VPC Creation', () => {
    ...
    it('Given a configuration with custom CIDR block, When creating a VPC construct, Then it should US_EAST the custom CIDR block', () => {
  ...
  describe('Synth Output Fields', () => {
    it('Given a VPC construct, When synthesizing the stack, Then the synthesized output should have correct fields', () => {
      const vpcProps = {};
      const stack = new TestStack(app, 'test-stack', config, vpcProps);
      ...
      // Check resource structure for aws_vpc
