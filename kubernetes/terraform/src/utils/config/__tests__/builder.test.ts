...
describe('ConfigBuilder', () => {
  ...
  describe('Given complete configuration with all settings', () => {
    describe('When building the configuration', () => {
      it('Then it should have all specified values', () => {
        const tags = { owner: 'team-a', project: 'test-project' };
  ...
  describe('Given CIDR block configuration', () => {
    ...
    describe('When not setting vpcCIDRBlock', () => {
      it('Then it should be using the default', () => {
        const config = new ConfigBuilder().withTerraformConfig('workspace', 'org').build();
        expect(config.vpcCIDRBlock).toBeDefined();
      });
    });
  ...
  describe('Given Kubernetes configuration', () => {
    describe('When setting KubernetesConfig properties', () => {
      it('Then they should be present and correctly assigned in the config', () => {
        ...
        const eksAddOns = ['vpc-cni', 'coredns'];
