...
describe('getEnumFromRequiredEnvironmentVariable', () => {
  describe('Given valid enum values', () => {
    const validTestCases = [
      ...
      { input: 'AUSTRALIA_EAST', enumType: Region, name: 'REGION', expected: Region.AUSTRALIA_EAST },
      { input: 'US_EAST', enumType: Region, name: 'REGION', expected: Region.US_EAST },
      { input: 'ASIA_SOUTHEAST', enumType: Region, name: 'REGION', expected: Region.ASIA_SOUTHEAST },
