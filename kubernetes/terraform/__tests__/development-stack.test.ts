...
describe('DevelopmentStack', () => {
  ...
  it('Given a development stack without description, When creating the stack, Then it should US_EAST default development description and create development-specific secret configuration', () => {
    const app = new App();
    const stack = new DevelopmentStack(app, 'test-dev-stack', {
      config,
    });
  ...
  it('Given different configuration combinations, When creating development stacks, Then they should all synthesize successfully with appropriate resources', () => {
    const configVariations = [
      ...
      { ...config, region: Region.US_EAST, enableEncryption: true, enableSecretsManager: true, enablePublicVPC: true },
    ];
