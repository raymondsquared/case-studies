...
export class ConfigBuilder {
  ...
  build(): Config {
    ...
    return {
      ...
      ...(this.config.vpcCIDRBlock ? { vpcCIDRBlock: this.config.vpcCIDRBlock } : {}),
      ...(this.config.publicSubnetCIDRBlocks ? { publicSubnetCIDRBlocks: this.config.publicSubnetCIDRBlocks } : {}),
      ...(this.config.privateSubnetCIDRBlocks ? { privateSubnetCIDRBlocks: this.config.privateSubnetCIDRBlocks } : {}),
